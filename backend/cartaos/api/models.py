...
class ProcessFileResponse(BaseModel):
    ...
    output_path: Optional[str] = Field(None, description="Path to output file if applicable")
...
class TriageResponse(BaseModel):
    ...
    confidence: Optional[float] = Field(None, description="Confidence score for the decision")

"""
Fixed test for the process file endpoint with proper decorator mocking.
"""
...
# Apply the decorator patch before importing the app
with patch("cartaos.processing.decorators.log_processing_stage", lambda x: lambda f: f):
    # Now import the app with the patched decorator

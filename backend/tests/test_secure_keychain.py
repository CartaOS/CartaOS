...
def test_keychain_store_key():
    ...
    with patch('keyring.set_password') as mock_set:
        ...
        mock_set.assert_called_once_with("CartaOS", "GEMINI_API_KEY", "test-api-key-123")
...
def test_ai_utils_keychain_integration():
    ...
    with patch('cartaos.utils.ai_utils.get_secure_api_key') as mock_get_key, \
...
def test_migration_from_env_to_keychain():
    ...
    with patch('cartaos.utils.keychain.load_dotenv'), \

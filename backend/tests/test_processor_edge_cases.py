...
def test_process_fails_when_text_extraction_none(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
...
def test_process_fails_when_generate_summary_none(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    pdf = make_pdf(tmp_path)
...
def test_save_summary_slugifies_filename(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:

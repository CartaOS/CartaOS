...
from cartaos.utils.triage import (ContentAwareTriage, DocumentAnalysis,
                                  DocumentType, TriageConfidence,
                                  TriageDecision)
...
class TestDocumentAnalysis:
    ...
    def test_analyze_document_complexity_high(self):
        ...
        with patch("builtins.open", side_effect=mock_open_handler):
            with patch("pathlib.Path.stat") as mock_stat:
                ...
                )  # High complexity (adjusted threshold)
    ...
    def test_analyze_document_language_detection(self):
        ...
        english_content = (
            "This is an English document with the and that standard vocabulary."
        )
...
class TestTriageDecisionMaking:
    ...
    def test_triage_fallback_mechanisms(self):
        ...
        with patch.object(
            triage, "analyze_document", side_effect=Exception("Analysis failed")
        ):
...
class TestPerformanceAndCaching:
    ...
    def test_analysis_caching(self):
        ...
        with patch("pathlib.Path.stat") as mock_stat:
            ...
            with patch.object(
                triage, "_perform_analysis", return_value=mock_analysis
            ) as mock_perform:
                # First call
